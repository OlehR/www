var Table = {
    ...
    renderDesctopOrder: function () {
        ...
        table += '<thead>';
        table += '<tr>';
        if(Table.renderSettings[0][1] == 1)
            table += '<th id="sort_by_brand">код</th>';
        if (Table.renderSettings[1][1] == 1)
            table += '<th id="sort_by_title">назва товару</th>';
        if (Table.sort != 'days') {
            if (Table.renderSettings[7][1] == 1)
                table += '<th title="' + title + '">1</th>';
            if (Table.renderSettings[8][1] == 1)
                table += '<th title="' + title + '">2</th>';
            if (Table.renderSettings[9][1] == 1)
                table += '<th title="' + title + '">3</th>';
            if (Table.renderSettings[10][1] == 1)
                table += '<th title="' + title + '">4</th>';
            if (Table.renderSettings[11][1] == 1)
            table += '<th title="' + title + '">5</th>';
        } else {
            if (Table.renderSettings[2][1] == 1)
                table += '<th title="' + title + '">1</th>';
            if (Table.renderSettings[3][1] == 1)
                table += '<th title="' + title + '">2</th>';
            if (Table.renderSettings[4][1] == 1)
                table += '<th title="' + title + '">3</th>';
            if (Table.renderSettings[5][1] == 1)
                table += '<th title="' + title + '">4</th>';
            if (Table.renderSettings[6][1] == 1)
            table += '<th title="' + title + '">5</th>';
        }
        if (Table.renderSettings[12][1] == 1)
            table += '<th title="середні продажі за тиждень">ср.</th>';
        if (Table.renderSettings[13][1] == 1)
            table += '<th>залишок</th>';
        if (Table.renderSettings[14][1] == 1)
            table += '<th>в дорозі</th>';
        if (Table.renderSettings[15][1] == 1)
            table += '<th>заказ шт.</th>';
        if (Table.renderSettings[16][1] == 1)
        table += '<th>в уп.</th>';
        table += '<th>заказ уп.</th>';
        if (Table.renderSettings[17][1] == 1)
        table += '<th>кратно п.</th>';
        ...
        if (arr.indexOfType(2)) {
            ...
            table += '<tr><td colspan="14" class="text-danger">Позиції які не потрапили в автозамовлення!</td></tr>';
            var arrTypeOther = arr.GetByType(0, 1);
            var arrTypeOtherLength = arrTypeOther.length;
            if (arrTypeOtherLength > 0){
    ...
    renderRawMob: function (arrLength, arr, title) {
        ...
        for (var i = 0; i < arrLength; i += 1) {
            ...
            table += '">';
            if (Table.seeBrands && (Table.prevBrand !== arr[i][3])) {
                table += '<div class="col-12 font-weight-bold">' + arr[i][3] + '</div>';
            }
            Table.prevBrand = arr[i][3];
            if (Table.renderSettings[0][1] == 1) {
                table += '<div id="sort_by_brand" class="col-4">код:</div>';
                table += '<div class="col-8">' + arr[i][0] + '</div>';
            }
            if (Table.renderSettings[1][1] == 1) {
                table += '<div id="sort_by_title" class="col-4">назва товару:</div>';
                table += '<div class="col-8">' + arr[i][1] + '</div>';
            }
            if (Table.sort == 'days') {
                if (Table.renderSettings[2][1] == 1) {
                    table += '<div class="col-4">1 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][6] + '</div>';
                }
                if (Table.renderSettings[3][1] == 1) {
                    table += '<div class="col-4">2 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][7] + '</div>';
                }
                if (Table.renderSettings[4][1] == 1) {
                    table += '<div class="col-4">3 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][8] + '</div>';
                }
                if (Table.renderSettings[5][1] == 1) {
                    table += '<div class="col-4">4 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][9] + '</div>';
                }
                if (Table.renderSettings[6][1] == 1) {
                    table += '<div class="col-4">5 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][10] + '</div>';
                }
            } else {
                if (Table.renderSettings[7][1] == 1) {
                    table += '<div class="col-4">1 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][11] + '</div>';
                }
                if (Table.renderSettings[8][1] == 1) {
                    table += '<div class="col-4">2 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][12] + '</div>';
                }
                if (Table.renderSettings[9][1] == 1) {
                    table += '<div class="col-4">3 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][13] + '</div>';
                }
                if (Table.renderSettings[10][1] == 1) {
                    table += '<div class="col-4">4 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][14] + '</div>';
                }
                if (Table.renderSettings[11][1] == 1) {
                    table += '<div class="col-4">5 ' + title + ':</div>';
                    table += '<div class="col-8">' + arr[i][15] + '</div>';
                }
            }
            if (Table.renderSettings[12][1] == 1) {
                table += '<div class="col-4">ср.:</div>';
                table += '<div class="col-8 font-weight-bold">' + arr[i][17] + '</div>';
            }
            if (Table.renderSettings[13][1] == 1) {
                table += '<div class="col-4">залишок:</div>';
                table += '<div class="col-8 font-weight-bold text-danger">' + arr[i][16] + '</div>';
            }
            if (Table.renderSettings[14][1] == 1) {
                table += '<div class="col-4">в дорозі:</div>';
                table += '<div class="col-8">' + arr[i][18] + '</div>';
            }
            if (Table.renderSettings[15][1] == 1) {
                table += '<div class="col-4">заказ шт.:</div>';
                table += '<div class="col-8 orderCount font-weight-bold text-success">' + arr[i][4] + '</div>';
            }
            if (Table.renderSettings[16][1] == 1) {
                table += '<div class="col-4">в уп.:</div>';
    ...
    renderRawDsc: function (arrLength, arr, title) {
        ...
        for (var i = 0; i < arrLength; i += 1) {
            if (Table.seeBrands && (Table.prevBrand !== arr[i][3])) {
                table += '<tr>';
                table += '<td colspan="15" class="font-weight-bold">' + arr[i][3] + '</td>';
                table += '</tr>';
            }
            Table.prevBrand = arr[i][3];
            ...
            if (Table.sort == 'days') {
                ...
                if (Table.renderSettings[5][1] == 1)
                    table += '<td>' + arr[i][9] + '</td>';
                if (Table.renderSettings[6][1] == 1)
                    table += '<td>' + arr[i][10] + '</td>';
            } else {
                if (Table.renderSettings[7][1] == 1)
                    table += '<td>' + arr[i][11] + '</td>';
                if (Table.renderSettings[8][1] == 1)
                    table += '<td>' + arr[i][12] + '</td>';
                if (Table.renderSettings[9][1] == 1)
                    table += '<td>' + arr[i][13] + '</td>';
                if (Table.renderSettings[10][1] == 1)
                    table += '<td>' + arr[i][14] + '</td>';
                if (Table.renderSettings[11][1] == 1)
                    table += '<td>' + arr[i][15] + '</td>';
            }
            if (Table.renderSettings[12][1] == 1)
                table += '<td class="font-weight-bold">' + arr[i][17] + '</td>';
            if (Table.renderSettings[13][1] == 1)
                table += '<td class="font-weight-bold text-danger">' + arr[i][16] + '</td>';
            if (Table.renderSettings[14][1] == 1)
                table += '<td>' + arr[i][18] + '</td>';
            if (Table.renderSettings[15][1] == 1)
                table += '<td class="orderCount font-weight-bold text-success">' + arr[i][4] + '</td>';
            if (Table.renderSettings[16][1] == 1) {
                table += '<td>' + arr[i][32] + '</td>';
            }
            table += '<td> <input ' + (!isEdit ? 'readonly' : '') + ' class="form-control pack" type="number" value="' + (parseFloat(arr[i][4]) / parseFloat(arr[i][32])) + '" /></td>';
            if (Table.renderSettings[17][1] == 1)
            table += '<td>' + arr[i][33] + '</td>';
            table += '<td> <input ' + (!isEdit ? 'readonly' : '') + ' class="form-control logistic" type="number" value="' + (parseFloat(arr[i][4]) * parseFloat(arr[i][33])) + '" /></td>';
            table += '</tr>';
        }
        return table;
    },
    ...
    onFocus: function () {
        ...
        infoContent += '<span>';
        if (Table.renderSettings[1][1] == 2) {
            infoContent += ' ' + Table.JSON.OrderField.Data[1][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][1];
            infoContent += '<br/>';
        }
        infoContent += 'Ост. прихід:' + Table.JSON.OrderDetail.Data[rowIndex][44] + ', '
            + (parseInt(Table.JSON.OrderDetail.Data[rowIndex][31]) == 1 ? 'T' : '')
            + (parseInt(Table.JSON.OrderHead.ISLCWAREHOUSE) == 1 ? " КC: " : '')
            + Table.JSON.OrderDetail.Data[rowIndex][37];
        if (Table.renderSettings[0][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[0][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][0];
        if (Table.renderSettings[2][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[2][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][0];
        if (Table.renderSettings[3][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[3][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][6];
        if (Table.renderSettings[4][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[4][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][7];
        if (Table.renderSettings[5][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[5][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][8];
        if (Table.renderSettings[6][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[6][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][9];
        if (Table.renderSettings[7][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[3][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][10];
        if (Table.renderSettings[8][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[8][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][11];
        if (Table.renderSettings[9][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[9][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][12];
        if (Table.renderSettings[10][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[10][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][13];
        if (Table.renderSettings[11][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[11][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][14];
        if (Table.renderSettings[12][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[12][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][17];
        if (Table.renderSettings[13][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[13][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][16];
        if (Table.renderSettings[14][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[14][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][18];
        if (Table.renderSettings[15][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[15][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][4];
        if (Table.renderSettings[16][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[16][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][32];
        if (Table.renderSettings[17][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[17][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][33];
        if (Table.renderSettings[18][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[18][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][44];
        if (Table.renderSettings[19][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[19][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][45];
        if (Table.renderSettings[20][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[20][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][5];
        if (Table.renderSettings[21][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[21][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][46];
        if (Table.renderSettings[22][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[22][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][30];
        if (Table.renderSettings[23][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[23][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][29];
        if (Table.renderSettings[24][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[24][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][52];
        if (Table.renderSettings[25][1] == 2)
            infoContent += ' ' + Table.JSON.OrderField.Data[25][3] + ': ' + Table.JSON.OrderDetail.Data[rowIndex][39];
        infoContent += '</span>';
        infoContent += '</div></div>';
        if (!el.prop('readonly'))
            el.val('');
...
<<<<<<< HEAD
        var data = {};
         ...
         Ndata={}   
         Ndata.data=JSON.stringify(data)
/*        var html = '<body>';
...
=======
        ...
        $.ajax({
            ...
            method: "POST",
            data: obj,
>>>>>>> e67da06ee81704664ff92e1f56aeff45c82508a1
            xhrFields: {
                withCredentials: true
            },
            success: function (data) {
